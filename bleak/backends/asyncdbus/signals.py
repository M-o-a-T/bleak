...
from asyncdbus.errors import InvalidObjectPathError
from asyncdbus.message import Message
from asyncdbus.validators import (
    assert_interface_name_valid,
    assert_member_name_valid,
    assert_object_path_valid,
)

from .defs import PROPERTIES_INTERFACE
...
async def add_match(bus: MessageBus, rules: MatchRules) -> Coroutine[Any, Any, Message]:
...
async def remove_match(bus: MessageBus, rules: MatchRules) -> Coroutine[Any, Any, Message]:
